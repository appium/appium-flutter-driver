...
| appium:isolateId | The isolate id to attach to as the initial attempt. A session can change the isolate with `flutter:setIsolateId` command. | `isolates/2978358234363215`, `2978358234363215` |
